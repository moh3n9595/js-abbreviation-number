import unabbreviateNumber from "../functions/unabbreviateNumber";

test("0 shoud be Error", () => {
  expect(() => unabbreviateNumber("0")).toThrow(
    new Error("This is not a valid input"),
  );
});

test("0000 shoud be Error", () => {
  expect(() => unabbreviateNumber("0000")).toThrow(
    new Error("This is not a valid input"),
  );
});

test("-25 shoud be Error", () => {
  expect(() => unabbreviateNumber("-25")).toThrow(
    new Error("This is not a valid input"),
  );
});
